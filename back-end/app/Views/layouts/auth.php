...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>/admin_assets/img/favicon.png">
...
<body>
  <div class="main-wrapper login-body">
    <div class="login-wrapper">
      <div class="container">
        <div class="loginbox">
          <div class="login-left"> <img class="img-fluid" src="<?= base_url() ?>/admin_assets/img/logo.png" alt="Logo"> </div>
